...
# Añade la ruta del proyecto al sys.path para que Alembic encuentre los módulos de la app
...
# target_metadata = None # <--- Comenta o borra esta línea
target_metadata = Base.metadata # <--- Añade esta línea
